...
export interface NhPhotosGet$Params {
...
export function nhPhotosGet(http: HttpClient, rootUrl: string, params: NhPhotosGet$Params, context?: HttpContext): Observable<StrictHttpResponse<Array<NhPhoto>>> {
  const rb = new RequestBuilder(rootUrl, nhPhotosGet.PATH, 'get');
  if (params) {
  ...
  return http.request(
    ...
    map((r: HttpResponse<any>) => {
      return r as StrictHttpResponse<Array<NhPhoto>>;
    })
  );
}

nhPhotosGet.PATH = '/nh/photos';
