...
export interface NhBugsBugGet$Params {
...
export function nhBugsBugGet(http: HttpClient, rootUrl: string, params: NhBugsBugGet$Params, context?: HttpContext): Observable<StrictHttpResponse<NhBug>> {
  const rb = new RequestBuilder(rootUrl, nhBugsBugGet.PATH, 'get');
  if (params) {
    rb.path('bug', params.bug, {});
  ...
  return http.request(
    ...
    map((r: HttpResponse<any>) => {
      return r as StrictHttpResponse<NhBug>;
    })
  );
}

nhBugsBugGet.PATH = '/nh/bugs/{bug}';
