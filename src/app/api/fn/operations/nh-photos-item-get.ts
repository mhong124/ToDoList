...
import { NhPhoto } from '../../models/nh-photo';

export interface NhPhotosItemGet$Params {
...
export function nhPhotosItemGet(http: HttpClient, rootUrl: string, params: NhPhotosItemGet$Params, context?: HttpContext): Observable<StrictHttpResponse<NhPhoto>> {
  const rb = new RequestBuilder(rootUrl, nhPhotosItemGet.PATH, 'get');
  if (params) {
  ...
  return http.request(
    ...
    map((r: HttpResponse<any>) => {
      return r as StrictHttpResponse<NhPhoto>;
    })
  );
}

nhPhotosItemGet.PATH = '/nh/photos/{item}';
