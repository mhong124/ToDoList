...
export interface NhFossilsGroupsGet$Params {
...
export function nhFossilsGroupsGet(http: HttpClient, rootUrl: string, params: NhFossilsGroupsGet$Params, context?: HttpContext): Observable<StrictHttpResponse<Array<NhFossilGroup>>> {
  const rb = new RequestBuilder(rootUrl, nhFossilsGroupsGet.PATH, 'get');
  if (params) {
  ...
  return http.request(
    ...
    map((r: HttpResponse<any>) => {
      return r as StrictHttpResponse<Array<NhFossilGroup>>;
    })
  );
}

nhFossilsGroupsGet.PATH = '/nh/fossils/groups';
