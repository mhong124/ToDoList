...
export interface NhToolsToolGet$Params {
...
export function nhToolsToolGet(http: HttpClient, rootUrl: string, params: NhToolsToolGet$Params, context?: HttpContext): Observable<StrictHttpResponse<NhTool>> {
  const rb = new RequestBuilder(rootUrl, nhToolsToolGet.PATH, 'get');
  if (params) {
    rb.path('tool', params.tool, {});
  ...
  return http.request(
    ...
    map((r: HttpResponse<any>) => {
      return r as StrictHttpResponse<NhTool>;
    })
  );
}

nhToolsToolGet.PATH = '/nh/tools/{tool}';
