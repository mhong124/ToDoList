...
import { NhFossilGroupWithIndividualFossilsNoMatched } from '../../models/nh-fossil-group-with-individual-fossils-no-matched';

export interface NhFossilsAllGet$Params {
...
export function nhFossilsAllGet(http: HttpClient, rootUrl: string, params: NhFossilsAllGet$Params, context?: HttpContext): Observable<StrictHttpResponse<Array<NhFossilGroupWithIndividualFossilsNoMatched>>> {
  const rb = new RequestBuilder(rootUrl, nhFossilsAllGet.PATH, 'get');
  if (params) {
  ...
  return http.request(
    ...
    map((r: HttpResponse<any>) => {
      return r as StrictHttpResponse<Array<NhFossilGroupWithIndividualFossilsNoMatched>>;
    })
  );
}

nhFossilsAllGet.PATH = '/nh/fossils/all';
