...
import { NhFossilGroupWithIndividualFossils } from '../../models/nh-fossil-group-with-individual-fossils';

export interface NhFossilsAllFossilGet$Params {
...
export function nhFossilsAllFossilGet(http: HttpClient, rootUrl: string, params: NhFossilsAllFossilGet$Params, context?: HttpContext): Observable<StrictHttpResponse<NhFossilGroupWithIndividualFossils>> {
  const rb = new RequestBuilder(rootUrl, nhFossilsAllFossilGet.PATH, 'get');
  if (params) {
    rb.path('fossil', params.fossil, {});
  ...
  return http.request(
    ...
    map((r: HttpResponse<any>) => {
      return r as StrictHttpResponse<NhFossilGroupWithIndividualFossils>;
    })
  );
}

nhFossilsAllFossilGet.PATH = '/nh/fossils/all/{fossil}';
