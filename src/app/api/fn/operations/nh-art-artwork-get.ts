...
export interface NhArtArtworkGet$Params {
...
export function nhArtArtworkGet(http: HttpClient, rootUrl: string, params: NhArtArtworkGet$Params, context?: HttpContext): Observable<StrictHttpResponse<NhArtwork>> {
  const rb = new RequestBuilder(rootUrl, nhArtArtworkGet.PATH, 'get');
  if (params) {
    rb.path('artwork', params.artwork, {});
  ...
  return http.request(
    ...
    map((r: HttpResponse<any>) => {
      return r as StrictHttpResponse<NhArtwork>;
    })
  );
}

nhArtArtworkGet.PATH = '/nh/art/{artwork}';
