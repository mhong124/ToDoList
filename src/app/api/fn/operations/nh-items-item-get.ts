...
export interface NhItemsItemGet$Params {
...
export function nhItemsItemGet(http: HttpClient, rootUrl: string, params: NhItemsItemGet$Params, context?: HttpContext): Observable<StrictHttpResponse<NhItem>> {
  const rb = new RequestBuilder(rootUrl, nhItemsItemGet.PATH, 'get');
  if (params) {
  ...
  return http.request(
    ...
    map((r: HttpResponse<any>) => {
      return r as StrictHttpResponse<NhItem>;
    })
  );
}

nhItemsItemGet.PATH = '/nh/items/{item}';
