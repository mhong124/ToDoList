...
export interface NhFossilsIndividualsGet$Params {
...
export function nhFossilsIndividualsGet(http: HttpClient, rootUrl: string, params: NhFossilsIndividualsGet$Params, context?: HttpContext): Observable<StrictHttpResponse<Array<NhIndividualFossil>>> {
  const rb = new RequestBuilder(rootUrl, nhFossilsIndividualsGet.PATH, 'get');
  if (params) {
  ...
  return http.request(
    ...
    map((r: HttpResponse<any>) => {
      return r as StrictHttpResponse<Array<NhIndividualFossil>>;
    })
  );
}

nhFossilsIndividualsGet.PATH = '/nh/fossils/individuals';
